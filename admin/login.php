...
session_start();error_reporting(0);if($_GET['act']=='logout'){unset($_SESSION);header('location: ./login.php');die;}$tips='';if($_POST['username']&& $_POST['password']){include('../inc/cdkj.config.php');$admin_name=htmlspecialchars($_POST['username']);$admin_pass=md5ff(htmlspecialchars($_POST['password']));if($admin_name==$cdkj['admin_name']&& $admin_pass==$cdkj['admin_pass']){$_SESSION['admin_cdkj']='ccfa7c0cc7b1a4e8';echo '<script>window.location.href="./index.php";</script>';die;}else{$tips='账号或密码错误！';}}function md5ff($xzv_0=1){return md5($xzv_0.'ff371');}?>
<?='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>后台管理登录 - Powered By  </title>
...
<tr class="header">
			<td colspan="4" align="center" style=" height:30px; font-size:18px; font-weight:bold;">七星源码系统登陆</td>
		</tr>
		<tr>
			<td width="117" align="right" valign="middle" class="tx" style="font-size:16px;">用户名：</td>
		  <td width="260" align="left" valign="middle"><input name="username" type="text" class="inp" id="username" value="" size="30" maxlength="32" autocomplete="off"><span class="gray_cac2b517289c5add tips">默认:admin</span></td>
		</tr>
		<tr>
			<td valign="middle" align="right" class="tx" style="font-size:16px;">密　码：</td>
		  <td align="left" valign="middle"><input name="password" type="password" class="inp" id="password" value="" size="30" maxlength="64"><span class="gray_cac2b517289c5add tips">默认:admin</span></td>
		</tr>
